...
NSString *const applicationStatesPlist = @"data/Library/FrontBoard/applicationState.plist";
...
NSURL * applicationStatePlistURL(NSString *UDID)
{
    return [deviceURL(UDID) URLByAppendingPathComponent:applicationStatesPlist];
}
